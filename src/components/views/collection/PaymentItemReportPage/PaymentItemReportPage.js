...
import {getPayment} from 'redux/modules/payments/actions';
...
const enhance = compose(
  ...
  connect((state, props) => ({
    ...
    paymentCreatedAt: get(state.payments, 'payment.created_at'),
    tabMember: get(state.payments, 'payment.tab_member'),
    paymentItem: get(state.payments, 'payment.payment_items', []).find(
